...
keymap.set("n", "<leader>g", "<C-w>s") -- split window horizontally
keymap.set("n", "<leader>gh", "<C-w>=") -- make split windows equal width & height
keymap.set("n", "<leader>w", ":close<CR>") -- close current split window

keymap.set("n", "<leader>t", ":tabnew<CR>") -- open new tab
keymap.set("n", "<leader>tg", ":tabclose<CR>") -- close current tab
...
----------------------
-- vim-maximizer
keymap.set("n", "<leader>gh", ":MaximizerToggle<CR>") -- toggle split window maximization
